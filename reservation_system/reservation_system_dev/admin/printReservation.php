...
<br>
    ...
    <h3 id='customer-title'>Reservation</h3>
<table id="meta">
                <tr>
       ...
       <?php   
        ...
        <div>
            <br><strong>Inclusions with Room Reservations</strong>
            ...
            <br><strong>Important Information</strong>
                ...
                <p style ="text-indent: 50px;">Guest is required to present a valid ID upon check-in.</p>
                ...
                <p style ="text-indent: 50px;">Failure to arrive will be treated as No-Show and will incur the first night charge.</p>
