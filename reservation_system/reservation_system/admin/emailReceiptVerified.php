...
<address>
Arnedo, Bolinao, Pangasinan<br>

VAT Reg. TIN: 066-075-842-000<br>

<br>
</address>

<h3 id='customer-title'>Reservation Confirmed</h3>
...
<table id="meta">
                ...
                <tr>
                    <td class="meta-head">Received from</td>
...
<table width = "100%" style= "margin-top: 20px;">
  ...
  <tr>
    ...
    <td>Php <?php echo number_format($row['tran_amount']); ?></td> 
    <td>Php <?php echo number_format($row['tran_change']); ?></td> 
  </tr>
 <?php endwhile; ?>
  <tr>  
      <td colspan="2" align="right">Balance</td>  
      <td align="right">Php <?php echo number_format($balance); ?></td>        
  </tr>  
</table>
                  

        <div id="terms">
        <p><span style="color: red">Note: </span>Please pay the remaining balance upon check-in.</p>
          <div align="right">
