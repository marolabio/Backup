    ...
    if (isset($_POST['email'])) {
        ...
        if ($sql->num_rows > 0) {
	        ...
	        $mail->Body = "
	            ...
	            <a href='
	            http://rockgardenresort.com/barcode/resetPassword.php?email=$email&token=$token
	            '>http://rockgardenresort.com/barcode/resetPassword.php?email=$email&token=$token</a><br><br>
	            If you don’t use this link within 5 minutes, it will expire. To get a new password reset link, visit rockgardenresort.com/barcode/forgotPassword.php
                <br><br>
	            Kind Regards,<br>
	            Pacific Cybercafe
	        ";
...
<body class="bg">
    <div class="container" id="panel">
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3" style="background: white; text-align: center; padding: 20px; box-shadow: 10px 10px 5px #888888;">
